        ...
        <div className="max-w-4xl animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              className="bg-secondary hover:bg-secondary/90 text-foreground font-semibold shadow-accent group"
            >
              Our Services
            ...
            <Button
              ...
              className="bg-secondary hover:bg-secondary/90 text-foreground font-semibold shadow-accent"
            >
              Contact Us
            </Button>
          </div>
